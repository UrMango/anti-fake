...
export default function Home() {
  ...
  return (
    <div className="w-full overflow-x-hidden xl:w-[80rem] min-h-[calc(100vh)] flex flex-col pt-14 items-center justify-center text-foreground gap-6">
        ...
        <div className=" flex flex-col h-full items-center justify-center gap-2"> 
          <div className='flex flex-col items-center justify-center'>
            <div className='flex flex-row w-fit items-center gap-2'>
              <h1 className="text-4xl flex-shrink-0 lg:text-6xl font-extrabold text-center">Fake Filter</h1>
