...
export default function NotFound() {
	...
	return (
		<div dir='ltr' className='w-full xl:max-w-6xl h-[calc(100vh-3.55rem)] flex flex-col md:flex-row items-center justify-center text-foreground gap-1'>
			<div className='flex flex-col gap-2 items-center h-full justify-center md:h-fit md:items-start pl-4 pr-4 xl:pl-0 '>
